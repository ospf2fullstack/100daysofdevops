...
- [AWS](#aws)
  ...
  - [Day 11- Restricting S3 Bucket Access to Specific IP Addresses](#day-11--restricting-s3-bucket-access-to-specific-ip-addresses)
  - [Day 12- How to ensure that users can’t turn off CloudTrail](#day-12--how-to-ensure-that-users-cant-turn-off-cloudtrail)
  - [Day 13- How to stop/start EC2 instance on schedule basis to save cost](#day-13--how-to-stopstart-ec2-instance-on-schedule-basis-to-save-cost)
  - [Day 14- How to automate the process of EBS Snapshot Creation](#day-14--how-to-automate-the-process-of-ebs-snapshot-creation)
  - [Day 22-Introduction to Key Management System(KMS)](#day-22-introduction-to-key-management-systemkms)
  - [Day 23- How to encrypt EBS Volume using KMS](#day-23--how-to-encrypt-ebs-volume-using-kms)
  - [Day 24- How to encrypt S3 Bucket using KMS](#day-24--how-to-encrypt-s3-bucket-using-kms)
  - [Day 25-AWS S3 Bucket using Terraform](#day-25-aws-s3-bucket-using-terraform)
  - [Day 26-Introduction to IAM](#day-26-introduction-to-iam)
  - [Day 28- Introduction to VPC Flow Logs](#day-28--introduction-to-vpc-flow-logs)
  - [Day 29- Introduction to RDS — MySQL](#day-29--introduction-to-rds--mysql)
  - [Day 30-Introduction to AWS CLI](#day-30-introduction-to-aws-cli)
  - [Day 31-Introduction to VPC Peering](#day-31-introduction-to-vpc-peering)
  - [Day 32-Introduction to NAT Gateway](#day-32-introduction-to-nat-gateway)
  - [Day 33- On Demand Hibernate](#day-33--on-demand-hibernate)
  - [Day 35-AWS S3 Intelligent-Tiering (S3 INT)](#day-35-aws-s3-intelligent-tiering-s3-int)
  - [Day 36-Introduction to AWS System Manager](#day-36-introduction-to-aws-system-manager)
  - [Day 37- Automate the Process of AMI Creation Using System Manager Maintenance Windows](#day-37--automate-the-process-of-ami-creation-using-system-manager-maintenance-windows)
  - [Day 38-Introduction to Transit Gateway](#day-38-introduction-to-transit-gateway)
  - [Day 39-Introduction to VPC EndPoint](#day-39-introduction-to-vpc-endpoint)
  - [Day 40-Introduction to AWS Config](#day-40-introduction-to-aws-config)
  - [Day 41-Real-Time Apache Log Analysis using Amazon Kinesis and Amazon Elasticsearch Service](#day-41-real-time-apache-log-analysis-using-amazon-kinesis-and-amazon-elasticsearch-service)
  - [Day 42-Audit your AWS Environment](#day-42-audit-your-aws-environment)
  - [Day 43- Introduction to EC2](#day-43--introduction-to-ec2)
  - [Day 44-S3 Cross Region Replication(CRR)](#day-44-s3-cross-region-replicationcrr)
  - [Day 45-Simple Backup Solution using S3, Glacier and VPC Endpoint](#day-45-simple-backup-solution-using-s3-glacier-and-vpc-endpoint)
  - [Day 46-Introduction to Amazon Glacier](#day-46-introduction-to-amazon-glacier)
  - [Day 47-Introduction to Amazon Elastic File System (EFS)](#day-47-introduction-to-amazon-elastic-file-system-efs)
  - [Day 48- Threat detection and mitigation at AWS](#day-48--threat-detection-and-mitigation-at-aws)
  - [Day 49-Introduction to Route53](#day-49-introduction-to-route53)
  - [Day 50-Introduction to Route53 Failover](#day-50-introduction-to-route53-failover)
  - [Day 69-Introduction to AWS Lambda](#day-69-introduction-to-aws-lambda)
  - [Day 70-Introduction to Boto3](#day-70-introduction-to-boto3)
  - [Day 71-EC2 Instance creation using Lambda](#day-71-ec2-instance-creation-using-lambda)
  - [Day 92-Choosing Right EC2 Instance Type](#day-92-choosing-right-ec2-instance-type)
  - [Day 98- AWS Lambda with Terraform Code http://100daysofdevops.com/100-days-of-devops-day-98-aws-lambda-with-terraform-code/](#day-98--aws-lambda-with-terraform-code-http100daysofdevopscom100-days-of-devops-day-98-aws-lambda-with-terraform-code)
  - [Day 99- AWS Boto3 http://100daysofdevops.com/100-days-of-devops-day-99-aws-boto3/](#day-99--aws-boto3-http100daysofdevopscom100-days-of-devops-day-99-aws-boto3)
  - [Day 15- Introduction to Terraform](#day-15--introduction-to-terraform)
  - [Day 16- Building VPC using Terraform](#day-16--building-vpc-using-terraform)
  - [Day 17- Creating EC2 Instance using Terraform](#day-17--creating-ec2-instance-using-terraform)
  - [Day 18-Add monitoring to these instances using Terraform(CloudWatch and SNS)](#day-18-add-monitoring-to-these-instances-using-terraformcloudwatch-and-sns)
  - [Day 19 – Application Load Balancer using Terraform](#day-19--application-load-balancer-using-terraform)
  - [Day 20— Auto-Scaling Group using Terraform](#day-20-auto-scaling-group-using-terraform)
  - [Day 21- MySQL RDS Database Creation using Terraform](#day-21--mysql-rds-database-creation-using-terraform)
  - [Day 27- Introduction to Packer](#day-27--introduction-to-packer)
  - [Day 34- Terraform Pipeline using Jenkins](#day-34--terraform-pipeline-using-jenkins)
  - [Day 51-Introduction to Bash Scripting](#day-51-introduction-to-bash-scripting)
  - [Day 52-Conditional Testing in Shell](#day-52-conditional-testing-in-shell)
  - [Day 53-Introduction to Regular Expression — Part 1](#day-53-introduction-to-regular-expression--part-1)
  - [Day 65-Bash Script to Monitor Service](#day-65-bash-script-to-monitor-service)
  - [Day 85- Shell Script to find the failed login](#day-85--shell-script-to-find-the-failed-login)
  - [Day 91-How to check if the file exists (Bash/Python)](#day-91-how-to-check-if-the-file-exists-bashpython)
  - [Day 54-And You Thought You Knew RPM](#day-54-and-you-thought-you-knew-rpm)
  - [Day 55-Introduction to YUM](#day-55-introduction-to-yum)
  - [Day 56-Debugging Performance Issue using SAR](#day-56-debugging-performance-issue-using-sar)
  - [Day 57-Debugging I/O Performance Issue](#day-57-debugging-io-performance-issue)
  - [Day 62-Useful Linux Command for Network Troubleshooting](#day-62-useful-linux-command-for-network-troubleshooting)
  - [Day 63- Wireshark for HTTP/HTTPS Analysis](#day-63--wireshark-for-httphttps-analysis)
  - [Day 66-Linux Boot Process](#day-66-linux-boot-process)
  - [Day 67-Introduction to Chrony](#day-67-introduction-to-chrony)
  - [Day 68-Introduction to Systemd](#day-68-introduction-to-systemd)
  - [Day 76-How Linux Kernel is organized](#day-76-how-linux-kernel-is-organized)
  - [Day 77-Process Management in Linux](#day-77-process-management-in-linux)
  - [Day 73- Introduction to Ansible](#day-73--introduction-to-ansible)
  - [Day 74- Introduction to GIT](#day-74--introduction-to-git)
  - [Day 58-Docker Basics](#day-58-docker-basics)
  - [Day 59- Introduction to DockerFile](#day-59--introduction-to-dockerfile)
  - [Day 72-Introduction to Kubernetes](#day-72-introduction-to-kubernetes)
  - [Day 60-Introduction to Jenkins](#day-60-introduction-to-jenkins)
  - [Day 61-Jenkins Agent Node](#day-61-jenkins-agent-node)
  - [Day 64- Regular Expression using Python](#day-64--regular-expression-using-python)
  - [Day 78- Python OS/Subprocess Module](#day-78--python-ossubprocess-module)
  - [Day 79-Apache Log Parser Using Python](#day-79-apache-log-parser-using-python)
  - [Day 80-Python Unit Testing(Pytest)](#day-80-python-unit-testingpytest)
  - [Day 81-Debugging Python Code](#day-81-debugging-python-code)
  - [Day 82- Python Object Oriented Programming(OOP)](#day-82--python-object-oriented-programmingoop)
  - [Day 86-Python Flow Control(if-else statement)](#day-86-python-flow-controlif-else-statement)
  - [Day 87-While/For Loop Python](#day-87-whilefor-loop-python)
  - [Day 88-Lists in Python](#day-88-lists-in-python)
  - [Day 89-Python Files I/O](#day-89-python-files-io)
  - [Day 90- Try and Except Statement Python](#day-90--try-and-except-statement-python)
  - [Day 93-Python Functions](#day-93-python-functions)
  - [Day 94-Introduction to Numpy for Data Analysis](#day-94-introduction-to-numpy-for-data-analysis)
  - [Day 95-Introduction to Django](#day-95-introduction-to-django)
  - [Day 75- Introduction to Fabric](#day-75--introduction-to-fabric)
  - [Day 83-Introduction to Splunk](#day-83-introduction-to-splunk)
  - [Day 84-Introduction to ElasticSearch](#day-84-introduction-to-elasticsearch)
  - [Day 96-Document Object Model(DOM)](#day-96-document-object-modeldom)
  - [Day 97-Introduction to JQuery](#day-97-introduction-to-jquery)
